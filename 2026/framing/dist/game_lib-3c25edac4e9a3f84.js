import * as __wbg_star0 from './snippets/game_lib-09da6449fcb9d06e/src/bindings.js';
import * as __wbg_star1 from './snippets/teleia-727bf4351691f1c8/src/helpers.js';
...
export function titlescreen_click() {
    wasm.titlescreen_click();
}
 ...
 */
export function start_game(nm, verb) {
    const ptr0 = passStringToWasm0(nm, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(verb) ? 0 : passStringToWasm0(verb, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    wasm.start_game(ptr0, len0, ptr1, len1);
}
 ...
 * @param {number} streak
 */
export function game_over(streak) {
    wasm.game_over(streak);
}
 ...
 */
export function set_leaderboard_highscore(highscore) {
    wasm.set_leaderboard_highscore(highscore);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_setTargetAtTime_95bf62b9eef6de02 = function() { return handleError(function (arg0, arg1, arg2, arg3) {
    ...
    imports.wbg.__wbg_stop_6d875c19a6df48fc = function() { return handleError(function (arg0) {
        arg0.stop();
    }, arguments) };
    imports.wbg.__wbg_stop_769013bf5186c20b = function() { return handleError(function (arg0, arg1) {
        arg0.stop(arg1);
    }, arguments) };
    ...
    imports['./snippets/game_lib-09da6449fcb9d06e/src/bindings.js'] = __wbg_star0;
    imports['./snippets/teleia-727bf4351691f1c8/src/helpers.js'] = __wbg_star1;
